        ...
        <div class="container">
            ...
            <div class="d-flex flex-row">
                ...
                <div class="flex-row-fluid ml-lg-8">
                    <!--begin::Card-->
                    <form wire:submit.prevent="dispatchPassword" class="form">
                        ...
                        <div class="card-header py-3">
                            ...
                            <div class="card-toolbar">
                                 <span class="px-4 pt-2 text-muted"
                                       x-data="{ open : false}"
                                       x-init="
                                      @this.on('notify-profile_reset_password', () => {
                                ...
                                <a href="{{ route('dashboard') }}" type="reset" class="btn btn-secondary">Cancel</a>
                            </div>
                        </div>
                        <!--end::Header-->
                        <!--begin::Form-->
                            ...
                            <div class="card-body">
                                ...
                                <div
                                    ...
                                    style="display: none"
                                    x-show.transition.out.duration.1000ms="open"
                                    class="alert alert-custom alert-light-warning fade show mb-10" role="alert">
                                    ...
                                    <div class="alert-text font-weight-bold">Configure user passwords to periodically. To prevent access from unknown users,
                                        <br>and also prevent yourself from being locked out of the system!</div>
