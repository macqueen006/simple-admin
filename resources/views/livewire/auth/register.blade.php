...
{{--                    </a>--}}
                    <!--end::Aside header-->
                    <!--begin: Wizard Nav-->
                    <div class="wizard-nav pt-5 pt-lg-3 pb-10">
                        <!--begin::Wizard Steps-->
                        <div class="wizard-steps d-flex flex-column flex-sm-row">
                            <!--begin::Wizard Step 1 Nav-->
                            <div class="wizard-step flex-grow-1 flex-basis-0" style="color: #1BC5BD;display: inline-block;">
                                <div class="wizard-wrapper pr-7">
                                    ...
                                    <div class="wizard-label">
                                        <h3 class="wizard-title">{{ $pages[$currentPage]['heading'] }}</h3>
                                        <div class="wizard-desc">{{ $pages[$currentPage]['subheading'] }}</div>
                                    </div>
                        ...
                        @if($errors->isNotEmpty())
                            <div class="alert alert-custom alert-light-danger fade show mb-5" role="alert">
                                ...
                                <div class="alert-text">Oops! there is an error with your submission</div>
                ...
                <div>
                    <!--begin::Form-->
                    <form wire:submit.prevent="register" class="px-10" >
                        <!--begin: Wizard Step 1-->
                        @if($currentPage === 1)
                        <div>
                            <!--begin::Title-->
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input wire:model.lazy="name" type="text" class="form-control form-control-solid h-auto py-7 @error('name') border-danger @enderror px-6 border-1 rounded-lg font-size-h6" placeholder="Address Line 1" />
                                        @error('name')
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input wire:model.lazy="lastname" type="text" class="form-control @error('lastname') border-danger @enderror border-1 form-control-solid h-auto py-7 px-6  rounded-lg font-size-h6" placeholder="Address Line 2" />
                                        @error('lastname')
                                        <span class="form-text text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input wire:model.lazy="password" type="password" class="@error('password') border-danger @enderror border-1 form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" placeholder="Address Line 1" />
                                        @error('password')
                                        <span class="form-text text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input wire:model.lazy="confirmPassword" type="password" class="@error('confirmPassword') border-danger @enderror border-1 form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" placeholder="Address Line 2" />
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input wire:model.lazy="address1" type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" placeholder="Address Line 1" />
                                        @error('address1')
                                        <span class="form-text text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input wire:model.lazy="address2" type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" placeholder="Address Line 2" />
                                        @error('address2')
                                        <span class="form-text text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input wire:model.lazy="email" type="text" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6" placeholder="Email" />
                                        @error('email')
                                        <span class="form-text text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select wire:model.lazy="country" class="form-control form-control-solid h-auto py-7 px-5 border-0 rounded-lg font-size-h6">
                    ...
                    @endif
                        ...
                        <div class="d-flex justify-content-between pt-7">
                            <div class="mr-2">
                                ...
                                @else
                                <button wire:click="goToPreviousPage" type="button" class="btn btn-light-primary font-weight-bolder font-size-h6 pr-8 pl-6 py-4 my-3 mr-3" >
                            ...
                            <div>
                                ...
                                <button class="btn btn-primary font-weight-bolder font-size-h6 pl-8 pr-4 py-4 my-3" type="submit" >Submit
                                ...
                                @else
                                <button wire:click="goToNextPage" type="button" class="btn btn-primary font-weight-bolder font-size-h6 pl-8 pr-4 py-4 my-3" >Next
                                    <span class="svg-icon svg-icon-md ml-2">
											<!--begin::Svg Icon | path:../../../../assets/media/svg/icons/Navigation/Right-2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
