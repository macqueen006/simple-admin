                ...
                <div class="login-form">
                    ...
                    <form class="form" wire:submit.prevent="login">
                        ...
                        <div class="form-group">
                            ...
                            <input wire:model="email" class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0"
                        ...
                        <div class="form-group">
                            ...
                            <input wire:model="password" class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0"
                        ...
                        <div class="form-group d-flex flex-wrap justify-content-between align-items-center">
                            ...
                            <a href="{{ route('password_reset') }}" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5">Forgot
                                Password ?</a>
                        </div>
                        <!--end::Form group-->
                        <!--begin::Action-->
